...
public class CategoryController {
	 ...
	 * @param model
	 */
	@AuthorityMethod(roles = {RoleType.ROLE_ADMIN,RoleType.ROLE_PUBLISH})
	...
	public String addCategory(@Validated Category c,BindingResult br,HttpServletRequest req){
		if (br.hasErrors()) {
			return "category/categoryAddInput";
		}
		req.getServletContext().removeAttribute("navCates");
