	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<div class="row placeholders">
			...
			<div class="table-responsive">
 				<sf:form role="form" modelAttribute="cate">
				...
				<div class="form-group">
					定制栏目： <label><input type="radio" value="0"
						name="isCustom" checked="checked"/>否</label> <label><input type="radio"
						value="1" name="isCustom" />是</label>
				</div>
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-addon">链接内容</span> <input type="text"
							class="form-control" placeholder="link" name="customLink">
					</div>
				</div>
				<div class="form-group">
					属于导航栏： <label><input type="radio" value="0"
						name="isNavCate" checked="checked"/>否</label> <label><input type="radio"
						value="1" name="isNavCate" />是</label>
				</div>
				<div class="form-group">
					属于列表栏： <label><input type="radio" value="0"
						name="isListCate" checked="checked"/>否</label> <label><input type="radio"
				...
				<div class="form-group">
					是否推荐： <label><input type="radio" value="0"
						name="isRecommended" checked="checked"/>否</label> <label><input type="radio"
						value="1" name="isRecommended" />是</label>
				</div>
				<div class="form-group">
					栏目类别：
					<c:forEach items="${types}" var="t">
						<label> <input type="radio" value="${t.key }"
							name="categoryType" required/>${t.value}
						</label>
					</c:forEach>
				</div>
				<div class="form-group">
					栏目状态： <label><input type="radio" value="0"
						name="status" checked="checked"/>停用</label> <label><input type="radio"
						value="1" name="status" />启用</label>
				</div>
